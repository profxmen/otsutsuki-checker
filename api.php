...
echo ' <span class="badge badge-success">#CVC</span></span> </span> <span class="badge badge-success">'.$lista.'</span> <span class="badge badge-success"> '.$amount.' </span>  <span class="badge badge-success"> CVC CORRECT</span></span>  <span class="badge badge-success"> OTSUTSUKI </b> </span> </br>';
}

elseif(strpos($respo2, "lost_card" )) {
    echo '<span class="badge badge-success">#LIVE</span></span> </span> <span class="badge badge-success">'.$lista.'</span> <span class="badge badge-warning"> '.$amount.' </span>  <span class="badge badge-warning"> Lost Card </span></span>  <span class="badge badge-warning">  </b> </span> </br>';
}
elseif(strpos($respo2, "stolen_card" )) {
    echo '<span class="badge badge-success">#LIVE</span></span> </span> <span class="badge badge-success">'.$lista.'</span> <span class="badge badge-warning"> '.$amount.' </span>  <span class="badge badge-warning"> Stolen Card </span></span> <span class="badge badge-warning">  </b> </span> </br>';
}
elseif(strpos($respo2, "Your card's security code is incorrect." )) {
    echo '<span class="badge badge-success">#LIVE</span></span> </span> <span class="badge badge-success">'.$lista.'</span> <span class="badge badge-warning"> '.$amount.' </span>  <span class="badge badge-warning"> Your card security code is incorrect </span></span>  <span class="badge badge-warning"> </b> </span> </br>';
}
elseif(strpos($respo2, "incorrect_cvc" )) {
    echo '<span class="badge badge-success">#LIVE</span></span> </span> <span class="badge badge-success">'.$lista.'</span> <span class="badge badge-warning"> '.$amount.' </span>  <span class="badge badge-warning"> Your card security code is incorrect </span></span>  <span class="badge badge-warning">  </b> </span> </br>';
}
elseif(strpos($respo2, "pickup_card" )) {
    echo '<span class="badge badge-success">#LIVE</span></span> </span> <span class="badge badge-success">'.$lista.'</span> <span class="badge badge-warning"> '.$amount.' </span>  <span class="badge badge-warning"> Pickup Card</span></span>  <span class="badge badge-warning">  </b> </span> </br>';
}
